...
check_path=./performative_prediction/dataset_AGNews_arch_distilbert-base-uncased_shift_type_class_temperature_1_init_alpha_100_base_size_1000/seed_7/distilbert-base-uncased_AGNews_temp_1.0_round_20_final.pth
...
declare -a performative_temperature=(0.01 0.025 0.05)
