...
check_path=./performative_prediction/checkpoint_dataset_ImageNet100_arch_resnet18_shift_type_class_temperature_0.8_init_alpha_100_base_size_1000/round_25_vanilla_766txoj3/resnet18_ImageNet100_temp_0.8_round_25_final.pth
# path for training class marginals
...
declare -a performative_temperature=(0.1 0.3 0.6)
